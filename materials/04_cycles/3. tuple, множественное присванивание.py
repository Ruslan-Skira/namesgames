...
z1, z2, z3, *z4, z5 = some_long_tuple

# пример со строкой
mystr = 'На берегу пустынных волн Стоял он, дум великих полн'
first, *_, second = mystr.split(' ')
...
# примерчик
x1, x2 = input('unpacking two variables').split(' ')
print(f'{x1=} {x2=}')